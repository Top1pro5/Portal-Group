...
- ** Авто-оптимизация медиа:** При загрузке огромных фото (более 800px) система автоматически сжимает их с помощью Pillow, сохраняя место на сервере.
...
##  Визуальная концепция: "Antique Gold & Ivory"

Проект выполнен в классическом стиле с акцентом на типографику и благородные материалы:
- **Цветовая палитра:** Слоновая кость (`#fdfbf7`), чистый белый и золото (`#d4af37`).
- **Типографика:** Классические антиквы (`Georgia`, `serif`) для создания атмосферы надежности и премиальности.
- **Детали:** Двойные золотые границы, жесткие тени в стиле ретро-интерфейсов и "стеклянные" переходы.
